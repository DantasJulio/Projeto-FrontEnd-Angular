...
exports.GetUnitsService = void 0;
var core_1 = require("@angular/core");
var GetUnitsService = /** @class */ (function () {
    function GetUnitsService(htppClient) {
        this.htppClient = htppClient;
        this.apiUrl = "https://test-frontend-developer.s3.amazonaws.com/data/locations.json";
    }
    GetUnitsService.prototype.getAllUnits = function () {
        return this.htppClient.get(this.apiUrl);
    };
    GetUnitsService = __decorate([
        core_1.Injectable({
            providedIn: 'root'
        })
    ], GetUnitsService);
